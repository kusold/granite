...
- Follow the existing message style (`feat(quickshell): …`, `fix(quickshell): …`, `chore(beads): …`).
- At session end: close finished beads, commit anything left over, and push the branch.
